  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="artist" value="" placeholder="Input field">
  </div>

  <div class="form-group">
    <label for="">Lagu</label>
    <input type="text" class="form-control" name="lagu" value="" placeholder="Input field">
  </div>
